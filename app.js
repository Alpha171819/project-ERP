...
var verifyingRoomRouter = require('./routes/verifyingRoom');
var reserveRoomsRouter = require('./routes/reserveRooms');
...
app.use('/Roomverification', verifyingRoomRouter);
app.use('/reserving/rooms/in/db', reserveRoomsRouter);
